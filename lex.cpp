...
void Lex::setFileName (string filename) {
	this->filename = "./" + filename;
}
//******************************************
//判断是否为字母
bool Lex::IsLetter (char letter) {
